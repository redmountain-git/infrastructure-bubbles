...
}`});function eN(t){return String(t??"").replace(/[<>"'&;]/g,"")}function Dr(t,e={},n={}){for(let r of Object.keys(n)){if(r in e)continue;let o=r.replace(/[A-Z]/g,i=>`-${i.toLowerCase()}`);t.style.removeProperty(`--vector-${o}`)}for(let[r,o]of Object.entries(e??{})){let i=r.replace(/[A-Z]/g,s=>`-${s.toLowerCase()}`);t.style.setProperty(`--vector-${i}`,eN(o))}}var Ue=f(()=>{"use strict";qt();P_()});function ke(t,e){globalThis.customElements&&!customElements.get(t)&&customElements.define(t,e)}var te,He=f(()=>{"use strict";W();Ue();te=class extends zt{constructor(){super(...arguments);this._theme={}}get theme(){return this._theme}set theme(n){let r=this._theme;this._theme=n??{},this.isConnected&&Dr(this,this._theme,r)}connectedCallback(){super.connectedCallback(),Dr(this,this._theme)}}});function P(t="tx"){return`${t}-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}function w(t,e=4){let n=10**e;return Math.round((Number(t??0)+Number.EPSILON)*n)/n}function Ce(t,e=.1){let n=Number(e??.1);return w(Math.round(t/n)*n,tN(n))}function K(t,e=-1/0,n=1/0){return Math.min(n,Math.max(e,Number(t??0)))}function Q(t){return t.replaceAll("_"," ").replace(/\b\w/g,e=>e.toUpperCase())}function tN(t){let e=String(t);return e.includes(".")?e.split(".")[1].length:0}var bp=f(()=>{"use strict"});function O(t,e,n){t.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:n}))}var L_=f(()=>{"use strict"});function pe(t={}){return Object.fromEntries(Object.entries(t).map(([e,n])=>[e,Number(n??0)]))}function sN(t=[],e={}){let n=[...t].sort((r,o)=>Number(r.order??0)-Number(o.order??0)).map(r=>r.key);return[...new Set([...n,...Object.keys(e)])]}function Ln(t={}){return Object.values(t).reduce((e,n)=>e+Number(n??0),0)}function al(t={}){return Number.isFinite(Number(t.min))?Number(t.min):0}function cl(t={}){return Number.isFinite(Number(t.max))?Number(t.max):Tr}function he(t,e,n,r="hard"){return{key:t,type:e,severity:r,message:n}}function Ep(t={},e=Tr,n=Object.keys(t)){let r={},o=Ln(t),i=n.length?Number(e??Tr)/n.length:0;for(let s of n)r[s]=o>0?Number(t[s]??0)*Number(e??Tr)/o:i;return Mr(r,{},e,n[0])}function Nr({value:t={},key:e,target:n,constraints:r={},items:o=[],total:i=Tr}){let s=sN(o,t).filter(I=>I in t||I===e),a=[],c=Ep(t,i,s),l=pe(c),u=r[e]||{};if(!e||!(e in l))return{vector:Mr(l,r,i,e),hits:[he(e||"composition","sum","No active slice was available.")],delta:0};if(u.locked)return{vector:l,hits:[he(e,"locked",`${Q(e)} is locked.`)],delta:0};let d=Number(n),h=al(u),p=cl(u),g=K(d,h,p);g!==d&&a.push(he(e,g<=h?"min":"max",`${Q(e)} hit ${g<=h?"minimum":"maximum"} ${w(g,2)}%.`)),g=Ce(g,u.step??j_);let E=g-l[e];l[e]=g;let b=-E,D=new Set([e]),V=0;for(;H_(b)&&V<cN(s);){V+=1;let I=s.filter(j=>{if(D.has(j))return!1;let Ze=r[j]||{};return Ze.locked?(a.push(he(j,"locked",`${Q(j)} is locked.`)),D.add(j),!1):b<0?dN(l[j],Ze):fN(l[j],Ze)});if(!I.length){F_(l,e,b),a.push(he(e,"unreachable",`${Q(e)} was clamped because the remaining oils cannot absorb the change.`)),b=0;break}let le=I.reduce((j,Ze)=>j+V_(l[Ze]),0),ae=!1;for(let j of I){let Ze=r[j]||{},Ar=V_(l[j])/le,Lt=b*Ar,$t=al(Ze),Gt=cl(Ze),S=Lt;Lt<0&&l[j]+Lt<$t?(S=$t-l[j],l[j]=$t,D.add(j),a.push(he(j,"min",`${Q(j)} hit minimum ${w($t,2)}%.`))):Lt>0&&l[j]+Lt>Gt?(S=Gt-l[j],l[j]=Gt,D.add(j),a.push(he(j,"max",`${Q(j)} hit maximum ${w(Gt,2)}%.`))):l[j]+=S,b=pN(b-S),ae=ae||uN(S)}if(!ae){F_(l,e,b),a.push(he(e,"unreachable","No remaining oil can legally move.")),b=0;break}}return{vector:Mr(ll(l,r),r,i,e),hits:aN(a),delta:w(g-c[e],4)}}function ll(t={},e={}){return Object.fromEntries(Object.entries(t).map(([n,r])=>[n,Ce(r,e[n]?.step??j_)]))}function Mr(t={},e={},n=Tr,r=null){let o=pe(t),i=Object.keys(o),s=sl(Number(n??Tr)-Ln(o)),a=0;for(;H_(s)&&a<iN;){a+=1;let c=[r,...i.filter(u=>u!==r)].filter(u=>!!u),l=!1;for(let u of c){let d=e[u]||{};if(d.locked)continue;let h=al(d),p=cl(d),g=s>0?p-o[u]:o[u]-h;if(!lN(g))continue;let E=Math.sign(s)*Math.min(Math.abs(s),g);o[u]=sl(o[u]+E),s=sl(s-E),l=!0;break}if(!l)break}return o}function ul(t={},e={}){return[...new Set([...Object.keys(t),...Object.keys(e)])].reduce((r,o)=>r+Math.abs(Number(t[o]??0)-Number(e[o]??0)),0)}function aN(t=[]){let e=new Set;return t.filter(n=>{let r=`${n.key}:${n.type}:${n.message}`;return e.has(r)?!1:(e.add(r),!0)})}function cN(t){return t.length+oN}function H_(t){return Math.abs(Number(t??0))>_p}function lN(t){return Number(t??0)>U_}function uN(t){return Math.abs(Number(t??0))>U_}function dN(t,e){return Number(t??0)>al(e)+_p}function fN(t,e){return Number(t??0)<cl(e)-_p}function V_(t){return Math.max($_,Number(t??$_))}function sl(t){return w(t,nN)}function pN(t){return w(t,rN)}function F_(t,e,n){t[e]=sl(Number(t[e]??0)+Number(n??0))}var Tr,j_,nN,rN,_p,U_,$_,oN,iN,xe=f(()=>{"use strict";bp();L_();bp();Tr=100,j_=.1,nN=4,rN=7,_p=1e-7,U_=1e-9,$_=1e-4,oN=8,iN=100});var vs,wp=f(()=>{"use strict";W();nt();Ot();A_();He();xe();Ue();vs=class extends te{static{this.styles=[se,k_]}#e;get hits(){return this.#e}set hits(e){this.#e=e}constructor(){super(),this.hits=[],this.theme={}}render(){return C`
      <div class="feedback">
